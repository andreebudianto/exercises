...
function countProfit(shoppers) {
  ...
  // Buat variabel profit untuk menampung hasil akhir profit
  var profit = [];
  // Jika array shopper ada maka lakukan proses
...
function joinNames (array) {
  ...
  for (var i = 0; i < array.length; i++) {
    ...
    // Jika array saat ini adalah yang terakhir dan panjang array adalah 2 maka tambahkan " dan " sebelum array
    else if (i === array.length-1 && array.length === 2) {
      string = string + " dan " + array[i];
    } 
    // Jika array saat ini adalah yang terakhir dan panjang array lebih dari dua maka tambahkan ", dan " sebelum array
    else if (i === array.length-1 && array.length > 2) {
      string = string + ", dan " + array[i];
    } 
    // Jika array saat ini adalah array tengah maka tambahkan " , " sebelum array
    else {
      string = string + ", " + array[i];
    }
  }
